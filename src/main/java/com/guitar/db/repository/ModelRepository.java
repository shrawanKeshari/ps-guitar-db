...
//		return mods;
	...
	public Page<Model> getModelsByPriceRangeAndWoodTypePagable(BigDecimal lowest, BigDecimal highest, String wood) {
		Sort sort = new Sort(Sort.Direction.ASC, "name");
		Pageable page = new PageRequest(0, 2, sort);
		return modelJpaRepository.queryByPriceRangeAndWoodTypePagable(lowest, highest, "%" + wood + "%", page);
	}
